...
Usage:
    mise exec -- python -m forecast.src.backtest --days 30
    mise exec -- python -m forecast.src.backtest --days 30 --capacity 10 --power 5000 --plot
"""
...
def plot_day_comparison(
    ...
    plt.tight_layout()
    out_path = f"docs/forecast/backtest_{day_str}.png"
