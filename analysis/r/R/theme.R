...
#
# Usage:
#   source("analysis/r/R/theme.R")   # or via load_data.R which sources this
#
# Exports:
...
# save_plot() writes a ggplot object to analysis/r/output/<filename>.
...
save_plot <- function(plot, filename, width = 10, height = 6) {
  ...
  # Scripts are run from the project root via `Rscript analysis/r/scripts/...`
  out_dir <- "analysis/r/output"
