...
Usage:
    mise exec -- python -m analysis.python.src.controller --capacity 10 --power 5000
    mise exec -- python -m analysis.python.src.controller --capacity 10 --power 5000 --interval 1
"""
