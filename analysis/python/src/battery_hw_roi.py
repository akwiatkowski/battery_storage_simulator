...
Usage:
    ...
    mise exec -- python -m analysis.python.src.battery_hw_roi --start 2024-07-01 --end 2025-02-01
    mise exec -- python -m analysis.python.src.battery_hw_roi --max-towers 3
"""
...
def _plot_comparison(results: list[dict]) -> None:
    ...
    out_path = project_root() / "analysis" / "python" / "output" / "battery_hw_roi.png"
