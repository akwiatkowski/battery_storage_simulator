...
Usage:
    mise exec -- python -m analysis.python.src.volatility_analysis
    mise exec -- python -m analysis.python.src.volatility_analysis --max-towers 1
"""
...
def plot_results(
    ...
    out_path = (
        project_root() / "analysis" / "python" / "output" / "volatility_roi.png"
    )
