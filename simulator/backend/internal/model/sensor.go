...
const (
	...
	SensorPumpCurveOffset    SensorType = "pump_curve_offset"
...
var SensorHomeAssistantID = map[SensorType]string{
	...
	SensorPumpCurveOffset:   "sensor.aquaarea_temperature_offset_value",
	// Indoor climate
...
var SensorCatalog = map[SensorType]SensorInfo{
	...
	SensorPumpCurveOffset:   {Name: "Heating Curve Offset", Unit: "°C"},
	// Indoor climate
