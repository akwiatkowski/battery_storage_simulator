...
Run from project root:
    mise exec -- python battery_optimizer_wasm/scripts/export_data.py
"""
...
# Add project root to path so we can import from forecast
project_root = Path(__file__).resolve().parents[2]
sys.path.insert(0, str(project_root))

from forecast.src.backtest import load_data
from forecast.src.config import load_config
